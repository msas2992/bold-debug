...
class SCPI():
    ...
    def Query(self, command = '*IDN?'):
        try :
            ...
            print >> sys.stderr, 'Error instrument Query command %s'%command
            return None
    ...
    def Reset(self):
        try :
            ...
            print >> sys.stderr, 'Error instrument Reset command'
            return None


# inherit above SCPI commands
class Instrument_Hyperion(SCPI):
...
#             print >> sys.stderr, 'ERROR, no colorimeter found'
    ...
    def find_usb_instrument_OLD(self, vid, pid):
        try:
    ...
    def connect_usb_OLD(self, vid, pid):
        instr = self.find_usb_instrument(vid, pid)
...
#     HP = Instrument_Hyperion()
#     
#     #
# #    BR.connect_usb('0x1781','0x0E93')
#     HP.connect_usb('0x23CF','0x1080')
#     # HP.Reset()
# #    ret = HP.Query()
# #    print(ret)
# 
